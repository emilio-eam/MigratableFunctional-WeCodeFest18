...
import we.code.fest.migratable.testing.step2.lib.{InternalSearchOfficeService, SearchOfficeService, SearchOfficeNameService}
...
abstract class SearchOfficeInternalTestBase
  ...
  override lazy val searchNameService = SearchOfficeInternalTestBase.getSearchOfficeNameService(internalService, _.select(_.getName()), createSource)
...
object SearchOfficeInternalTestBase {
  ...
  def getSearchOfficeNameService(appliedSearchService: (JinqIterator[Office], String, String) => JinqIterator[Office], toNameView: JinqIterator[Office] => Iterator[String], getData: () => JinqIterator[Office]): SearchOfficeNameService =
